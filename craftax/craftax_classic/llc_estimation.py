...
#%%
def generate_trajectory(network_params, rng, num_envs=1000, num_steps=495):
...
jit_gen_traj_495 = jax.jit(lambda params, rng: generate_trajectory(params, rng, num_steps=100))
#%%
model_no = -1
